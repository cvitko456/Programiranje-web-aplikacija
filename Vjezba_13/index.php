...
<body>
	...
	if (!empty($_SESSION['news_title_1']) || !empty($_SESSION['news_title_2']) || !empty($_SESSION['news_title_3'])) {
        ...
        print '<p><a href="index.php?menu=2&action=1">' . $_SESSION['news_title_1'] . '</a></p>';
		}
		if(isset($_SESSION['news_title_2'])) {
			print '<p><a href="index.php?menu=2&action=2">' . $_SESSION['news_title_2'] . '</a></p>';
		}
		if(isset($_SESSION['news_title_3'])) {
			print '<p><a href="index.php?menu=2&action=3">' . $_SESSION['news_title_3'] . '</a></p>';
		}
		print '
		</aside>';
	}
